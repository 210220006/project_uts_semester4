...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>/aset/css/tree-viewer.css">
    ...
    <div class="wrapper">
        <div class="left-side">
            ...
            <div class="left-content">
                <ul role="tablist">
                    <li role="presentation"><a href="<?php echo base_url('admin')?>" aria-controls="home" role="tab" data-toggle="tab"><span><i class="fa fa-folder"></i></span>Admin</a></li>
                    <li role="presentation"><a href="<?php echo base_url('dosen')?>" aria-controls="home" role="tab" data-toggle="tab"><span><i class="fa fa-folder"></i></span>Dosen</a></li>
                    <li role="presentation"><a href="<?php echo base_url('mahasiswa')?>" aria-controls="home" role="tab" data-toggle="tab"><span><i class="fa fa-folder"></i></span>Mahasiswa</a></li>
                </ul>
            </div>
            <div class="copyright">
...
<p>The end of your pages, right before the closing "body" tag. Be sure to place js first, as our JavaScript plugins depend on them. </p>
	...
	<!-- summernote JS
		============================================ -->
        <script src="<?php echo base_url() ?>/aset/js/summernote.min.js"></script>
        <script src="<?php echo base_url() ?>/aset/js/summernote-active.js"></script>
	</xmp>
</pre>
    ...
    <script src="<?php echo base_url() ?>/aset/js/jquery-3.1.0.min.js"></script>
    <script src="<?php echo base_url() ?>/aset/js/bootstrap.min.js"></script>
	<script src="<?php echo base_url() ?>/aset/js/jstree.min.js"></script>
    <script src="<?php echo base_url() ?>/aset/js/jstree.active.js"></script>
